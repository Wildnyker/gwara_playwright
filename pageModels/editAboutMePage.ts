...
export class EditAboutMePage {
  ...
  constructor(page: Page) {
    this.page = page;
    this.editAboutMePageHeader = this.page.getByRole("heading", {
      name: /Редагувати сторінку користувача/i,
    });
    this.aboutMeTextbox = this.page.getByPlaceholder("Про мене");
    this.aboutMePlaceholder = this.page.getByPlaceholder("Про мене");
    this.confirmChangesButton = this.page.getByRole("button", {
      name: "Підтвердити зміни",
    });
  }
